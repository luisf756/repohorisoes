...
import aplicacion.controlador.util.JsfUtil;
import aplicacion.controlador.util.JsfUtil.PersistAction;
...
public class UsuariosController implements Serializable {
    ...
    @EJB
    private aplicacion.controlador.UsuariosFacade ejbFacade;
